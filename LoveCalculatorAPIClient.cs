...
namespace APIVerve
{
    public class LoveCalculatorAPIClient
    {
        ...
        public LoveCalculatorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }

        public LoveCalculatorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public ResponseObj Execute(lovecalculatorQueryOptions options)
        {
            try
            {
                if (_isDebug)
